...
st.title("Leo Machine Learning Web Application")
...
@st.cache
def loadDataset():
    dataset = pd.read_csv("bankmarketing.csv")
    return dataset


method = st.sidebar.selectbox(
    "Select Method : ",
    ("", "Loan-Prediction", "Marketing Analysis")
)

if method == "Loan-Prediction":
    ############
    print()

elif method == "Marketing Analysis":
    ...
    if dataset == "Bank-Marketing Dataset":
        ...
        combinedDf = clustering(bank_marketing)
